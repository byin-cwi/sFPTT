...
# python main_addTask_snn.py --dataset Add-Task --alpha 0.5 --beta 0.5 --clip 1.0 --lr 0.001 --optim 'Adam' --nhid 128 --log-interval 200 --epochs 10000 --parts 10 --bptt 200
# python main_addTask_snn.py --dataset Add-Task --alpha 0.5 --beta 0.5 --clip 1. --lr 0.003 --optim 'Adam' --nhid 128 --log-interval 200 --epochs 10000 --parts 10 --bptt 1000 --seed 444

from utils import get_xt
from add_task_snn import *
# from add_task_snn_lstm import *
# from add_task_snn_abl import *
# from add_task_lstm import *
# from add_task_rnn import *

from datasets import data_generator, adding_problem_generator
from train_classification import *
from torch.optim import lr_scheduler
# from train_addTask_snn import * # from fptt paper kag al 
from train_addTask_snn_fptt import *
# from train_addTask_snn_batch1 import *
# from train_addTask_snn_bptt import *
...
model = AddTaskModel(input_size, args.nhid )
...
# with open('snn_fptt_abl_adp_m(u,b).txt', 'w') as f:
# with open('snn_fptt_abl_Pm_Ga.txt', 'w') as f:
# with open('snn_fptt_abl_Pm_adp(x).txt', 'w') as f:
with open('snn_fpttt_2000_2000p.txt', 'w') as f:
    for item in all_test_losses:
        f.write("%s\n" % item)

# torch.save(model,'add1000.pth')
# import matplotlib.pyplot as plt

# w_m = model.layer1_tauM.weight.detach().cpu().numpy()
# w_adp = model.layer1_tauAdp.weight.detach().cpu().numpy()
# np.save('w_m.npy', w_m) 
# np.save('w_adp.npy', w_adp) 
# plt.plot(all_test_losses[0])
# # plt.ylim(0,.2)
# # plt.show()
# plt.savefig("add_snn_p500_fptt_mem_abl1.svg")