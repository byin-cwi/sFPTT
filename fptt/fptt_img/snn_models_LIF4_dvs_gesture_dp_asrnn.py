...
def save_checkpoint(state, is_best, prefix, filename='_snnl4s2-srnn_checkpoint.pth.tar'):
    print('saving at ', prefix+filename)
    torch.save(state, prefix+filename)
    if is_best:
        shutil.copyfile(prefix+filename, prefix+ '_snnl4s2-srnn_model_best.pth.tar')
