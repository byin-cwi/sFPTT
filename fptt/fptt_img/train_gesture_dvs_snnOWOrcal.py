...
# python train_gesture_dvs_snn.py --dataset DVS-Gesture --parts 28 --batch_size 128 --nhid 512 --lr 2e-3 --when 20 80 120 --epochs 8 --optim Adamax --log-interval 2
...
# from snn_LIF4_dvs_gesture_v1 import *
# from snn_models_LIF4_dvs_gesture_dp_plus_less import * 

# from asrnn_dvs_gesture_dp_plus import * 

# cnn model
# from snn_sota_LIF4_dvs_gesture import * 

# cnn model
# from snn_sota_LIF4_dvs_gesture_v1 import * # ltc_v2
...
def train(epoch, args, train_loader, permute, n_classes, model, named_params, logger):
    ...
    for batch_idx, (data, target) in enumerate(train_loader):
        ...
        for p in range(_PARTS):
            ...
            loss = clf_loss +  regularizer #+ model.network.fr*0.05
...
exp_name = args.dataset + '-WithOutOrcal -nhid-' + str(args.nhid) + '-parts-' + str(args.parts) + '-optim-' + args.optim
